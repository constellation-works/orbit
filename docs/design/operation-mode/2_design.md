...
| [Workspace auto job](../../../crates/orbit-core/assets/jobs/workspace_auto_pipeline.yaml) | One coordinator, default five live leaf runs, detached children, slot polling at 30 seconds and idle polling at 60 seconds. A successful coordinator is not evidence that its detached children succeeded. |
