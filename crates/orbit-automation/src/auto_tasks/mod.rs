...
//! - [`scheduler`] — the evaluator called by the host tick, plus the
//!   host-local, workspace-scoped last-fired cursors it reads.
...
pub const DEFAULT_AUTO_TASK_FILES: &[(&str, &str)] = &[
    (
