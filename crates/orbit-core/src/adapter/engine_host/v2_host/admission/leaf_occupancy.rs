...
pub(in crate::adapter::engine_host::v2_host) enum LeafRunPhase {
...
pub(in crate::adapter::engine_host::v2_host) struct LeafRunOccupancy {
    pub(in crate::adapter::engine_host::v2_host) run_id: String,
    pub(in crate::adapter::engine_host::v2_host) task_ids: Vec<String>,
    pub(in crate::adapter::engine_host::v2_host) phase: LeafRunPhase,
    /// Every descendant run the dispatch records name, deduplicated.
    pub(in crate::adapter::engine_host::v2_host) descendant_run_ids: Vec<String>,
    /// Selectors the gate is parked on, with the holders they resolve to.
    pub(in crate::adapter::engine_host::v2_host) lock_wait: Option<LockWait>,
    /// Why the phase is `unknown`, and only then.
    pub(in crate::adapter::engine_host::v2_host) unknown_reason: Option<&'static str>,
}

/// The gate's parked-lock record, resolved against current holders.
pub(in crate::adapter::engine_host::v2_host) struct LockWait {
    pub(in crate::adapter::engine_host::v2_host) gate_run_id: String,
    pub(in crate::adapter::engine_host::v2_host) selectors: Vec<String>,
    /// Selectors that map to a task currently holding a lock.
    pub(in crate::adapter::engine_host::v2_host) blockers: Vec<LockWaitBlocker>,
    ...
    pub(in crate::adapter::engine_host::v2_host) unresolved_selectors: Vec<String>,
}

pub(in crate::adapter::engine_host::v2_host) struct LockWaitBlocker {
    pub(in crate::adapter::engine_host::v2_host) selector: String,
    pub(in crate::adapter::engine_host::v2_host) holder_task_ids: Vec<String>,
}
...
pub(in crate::adapter::engine_host::v2_host) fn occupancy_json(
    runs: &[LeafRunOccupancy],
    free_slots: usize,
) -> Value {
...
pub(in crate::adapter::engine_host::v2_host) fn read_leaf_occupancy(
