...
pub(in crate::adapter::engine_host::v2_host) fn alert(
    number: u64,
    severity: &str,
    range: &str,
    ghsa: &str,
...
pub(in crate::adapter::engine_host::v2_host) fn snapshot(
    alerts: Vec<Value>,
...
pub(in crate::adapter::engine_host::v2_host) fn code_alert(number: u64, severity: &str) -> Value {
    json!({
