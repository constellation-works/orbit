...
pub(super) const DEPENDABOT_KEY_PREFIX: &str = "dependabot:";
const DEPENDABOT_TITLE_PREFIX: &str = "[dependabot-sweep] ";
pub(super) const CODE_TAG: &str = "code-scanning-sweep";
pub(super) const CODE_KEY_PREFIX: &str = "code-scanning:";
pub(super) const CODE_GROUP_KEY_PREFIX: &str = "code-scanning-group:";
pub(super) const CODE_TITLE_PREFIX: &str = "[code-scanning-sweep] ";
const SECRET_TAG: &str = "secret-scanning-sweep";
pub(super) const SECRET_KEY_PREFIX: &str = "secret-scanning:";
const SECRET_TITLE_PREFIX: &str = "[secret-scanning-sweep] ";
pub(super) const SYSTEM_CREW: &str = "system";
...
pub(super) fn append_collection_bounds(out: &mut String, truncation: Option<&Value>) {
...
pub(super) fn line_suffix(value: &Value) -> String {
...
pub(super) fn repository_name(snapshot: &Value) -> &str {
    snapshot
        .pointer("/repository/full_name")
        .and_then(Value::as_str)
        .unwrap_or("unknown repository")
...
pub(super) fn priority_for_rank(rank: u8) -> TaskPriority {
    match rank {
...
pub(super) fn alert_number(value: &Value) -> u64 {
