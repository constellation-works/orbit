...
use super::filing::{failure, snapshot};
            ...
            &json!({
                ...
                "results": [{
                    ...
                    "tasks": [{
                        ...
                        "assessment_rationale": "The repair changes a bounded CI failure path.",
                        "confidence": "high",
                        "evidence_gaps": [],
                        "validation_approach": "Re-run the failing CI command.",
                        "reassessment_triggers": ["the tested revision changes"],
                        "blocked_by": [],
