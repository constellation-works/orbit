...
pub use plugin::{
    ...
    PluginMigrateRequest, PluginPanelSummary, PluginPermissionChange, PluginPermissionSummary,
    PluginRemoveOptions, PluginSecretStatus, PluginSecretValue, PluginSeedAction,
