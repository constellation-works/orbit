...
use super::super::inspect::{
    ClockUnitInspection, ClockUnitVerdict, RunningBinary, inspect_clock_unit_at,
    probe_program_version, probe_program_version_within,
};
use super::super::install::render_systemd_service;
use super::super::manager::ClockPlatform;

pub(super) fn running(path: &str, version: &str) -> RunningBinary {
    RunningBinary {
...
pub(super) fn write_systemd_unit(home: &Path, program: &str) -> PathBuf {
